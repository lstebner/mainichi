...
(function() {
  var DEBUG_MODE, NodeArgs, answer_idx, colors, default_max_words, default_quiz_mode, dictionary_data, dictionary_data_raw, dictionary_file, fs, hint_idx, i, invert_at_random, invert_hints, line, max_words, process_args, process_end_time, process_setup_time, process_start_time, prompt, prompt_end_time, prompt_start_time, prompts, quiz_mode, quiz_modes, randomly_invert_hints, score_results, shuffle_words, theprompt, timed, word, words, _, _debug, _i, _len, _str;
